...
static void feier_class_init(ObjectClass *oc, void *data)
{
	DeviceClass *dc = DEVICE_CLASS(oc);

	dc->realize = feier_realize;
...
static const TypeInfo feier_type_info = {
	.name = TYPE_FEIER,
	.parent = TYPE_DEVICE,
	.instance_size = sizeof(FeierState),
	.instance_init = feier_init,
	.class_init = feier_class_init,
};

static void feier_register_types(void)
{
	type_register_static(&feier_type_info);
}

type_init(feier_register_types)
